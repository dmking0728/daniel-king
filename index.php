...
function render_header()
{
    template('partials/header', [
        ...
        'lead' => __('Tonik issss a WordPress Starter Theme which aims to modernize, organize and enhance some aspects of WordPress theme development. Take a look at what is waiting for you.'),
    ]);
}
